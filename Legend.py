...
\033[1;94mFACEBOOK  MR LEGEND AMAN
                  
\033[1;92mFB PAGE  NO PAGE
...
╔══──────────────────────────╗─══╗
║ OWNER 💓💓💓LEGEND AMAN           ║║
║  GITHUB 💝💝💝 MRLEGENDAMAN01   ║ ║
║ FACEBOOK 💝💝💝MRLEGENDAMAN01 ║ ║
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-https://wa.me/+919896743779')
    else:
